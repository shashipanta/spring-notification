<script>
  import {accountReq, registerUser } from "./UserRegistration";
...
<form method="post" on:submit|preventDefault={registerUser}>
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            <label for="user_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">First name</label>
            <input type="text" id="user_name" 
                    bind:value={accountReq.email}
